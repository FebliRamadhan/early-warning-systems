...
abstract class REST_Controller extends CI_Controller {
    ...
    public function _remap($object_called, $arguments = [])
    {
        ...
        {
            $this->response([
                    $this->config->item('rest_error_field_name') => TRUE,
                    $this->config->item('rest_code_field_name') => "405",
                    $this->config->item('rest_desc_field_name') => $this->lang->line('text_rest_unknown_method'),
                    $this->config->item('rest_data_field_name') => null
