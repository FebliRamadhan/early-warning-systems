...
/*
|--------------------------------------------------------------------------
| REST Error Field Name
|--------------------------------------------------------------------------
|
| The field name for the error inside the response
|
*/
$config['rest_error_field_name'] = 'error';

/*
|--------------------------------------------------------------------------
| REST Code Field Name
|--------------------------------------------------------------------------
|
| The field code for the error inside the response
|
*/
$config['rest_code_field_name'] = 'code';
